...
const TitleEvent = ({ eventDate, eventDateEnd }) => (
  <>
    Start date : {moment(eventDate).format("DD.MM.YYYY HH:mm:ss")} End Date :{" "}
    {moment(eventDateEnd).format("DD.MM.YYYY HH:mm:ss")}
  </>
);
...
function DataModal({ handleClose, data }) {
  const ViewData = {
    Title: data.dateTimePub ? TitleNews : TitleEvent,
